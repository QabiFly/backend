...
class User(
    ...
    udhaar_limit = models.DecimalField(max_digits=10, decimal_places=2, default=20000.00)
    current_udhaar = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
