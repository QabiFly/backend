...
class OrderPaymentSplit(models.Model):
    ...
    shopkeeper_amount = models.DecimalField(
        max_digits=12,
        decimal_places=2,
    ...
    def __str__(self):
        return f"Payment Split - Order {self.order.id}"
...
class Order(ModelWithMetadata, ModelWithExternalReference):
    ...
    weather_surcharge = models.DecimalField(
        max_digits=10, 
        decimal_places=2,
        default=Decimal('0.00')
    )
    is_udhaar = models.BooleanField(default=False)
