...
LOCATION_DEFAULT_LAT = float(os.environ.get("LOCATION_DEFAULT_LAT", "26.0524"))
LOCATION_DEFAULT_LON = float(os.environ.get("LOCATION_DEFAULT_LON", "84.1837"))
DELIVERY_RADIUS_KM = float(os.environ.get("DELIVERY_RADIUS_KM", "2.0"))
MIN_ORDER_FREE_DELIVERY = Decimal(os.environ.get("MIN_ORDER_FREE_DELIVERY", "50"))
PLATFORM_COMMISSION = float(os.environ.get("PLATFORM_COMMISSION", "5"))
DELIVERY_COMMISSION = float(os.environ.get("DELIVERY_COMMISSION", "3"))
UDHAAR_DEFAULT_LIMIT = Decimal(os.environ.get("UDHAAR_DEFAULT_LIMIT", "20000"))
...
# Redis Configuration
REDIS_URL = os.environ.get("REDIS_URL", "redis://default:v8S5qUXNF0hZdXWjK4Lo8rNaYrfXHB1K@redis-10830.crce217.ap-south-1-1.ec2.cloud.redislabs.com:10830")
